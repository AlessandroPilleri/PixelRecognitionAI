...
image.getImage(filename, function (values) {
  input = values;
  console.log(input);
  ...
  train.train(networks, function (trainedNetwork) {
    ...
    red = trainedNetwork.redNetwork.activate([input[0], input[3]]);
    green = trainedNetwork.greenNetwork.activate([input[1], input[2]]);
    orange = trainedNetwork.orangeNetwork.activate([input[0], input[3]]);
    violet = trainedNetwork.violetNetwork.activate([input[1], input[2]]);
